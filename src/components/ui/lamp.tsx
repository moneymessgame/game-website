...
export const LampContainer = ({
    ...
    return (
        <div
            className={cn(
                "relative flex min-h-[90vh] flex-col items-center justify-center overflow-hidden w-full rounded-md z-0",
                className
            )}
        >
						<div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 py-8">
                <motion.div
            ...
            <div className="relative z-50 flex -translate-y-80 flex-col items-center px-5 h-60 lg:h-50">
                {children}
            </div>
        </div>
    );
